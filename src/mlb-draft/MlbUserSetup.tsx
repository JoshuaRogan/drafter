...
import { getMlbPreconfiguredDrafters } from './MlbDraftContext';
...
export const MlbUserSetup: React.FC<Props> = ({ name, onNameChange }) => {
  const drafters = useMemo(() => getMlbPreconfiguredDrafters(), []);
